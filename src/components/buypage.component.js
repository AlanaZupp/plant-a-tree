...
export default class BuyPage extends Component {
    ...
    render() {
        return (
            ...
            <div align="center" className="col-xs-10 col-md-4 col-lg-4 infoDiv">
            ...
            <br></br>     
            <div align="center" className="col-xs-10 col-md-4 col-lg-4 deliveryDiv">
            ...
            <br></br>
            <div align="center" className="col-xs-10 col-md-4 col-lg-4 rating">
